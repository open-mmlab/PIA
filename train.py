...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    new_conv1 = InflatedConv3d(
        9, old_weights.shape[0], kernel_size=unet.conv_in.kernel_size,
        stride=unet.conv_in.stride, padding=unet.conv_in.padding, bias=True if old_bias is not None else False)
